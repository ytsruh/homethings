...
export type InsertWealthItem = typeof wealthItems.$inferInsert;
export type SelectWealthItem = typeof wealthItems.$inferSelect;

export const wealthValues = sqliteTable(
  "wealth_values",
  {
    id: text("id")
      .primaryKey()
    ...
    wealthItemId: text("wealth_item_id")
      .notNull()
      .references(() => wealthItems.id, { onDelete: "cascade" }),
...
export type InsertWealthValue = typeof wealthValues.$inferInsert;
export type SelectWealthValue = typeof wealthValues.$inferSelect;
