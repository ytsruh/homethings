...
export default function Home() {
	return (
		<>
			<title>Chris Hurst | Digital Marketer & TypeScript / Go Developer</title>
			<meta name="description" content="Chris Hurst's personal website" />
			<section className="flex w-full flex-col gap-y-5">
				...
				<div className="container mx-auto flex w-full items-center justify-between">
					<section className="w-full">
						...
						<p className="my-6 w-full text-lg">
							...
							have featured some of them below to show new technologies that
				...
				<div className="container mx-auto flex w-full items-center justify-between py-10">
					<section className="w-full">
						...
						<p className="my-6 w-full text-lg">
							With over 10 years of expereince in digital marketing I am a
							strong and well rounded leader of teams. I have a range of
							experience working in digital agenices as well multinational
							companies in various disiplines of digital & marketing.
						</p>
